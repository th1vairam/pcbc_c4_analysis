---
title: "Differential expression analysis for eXpress aligned data (DE's only)"
...
tmp <- merge(filter(PVAL[,c(1,3)],PVAL[,3]<=0.05),filter(FC[,c(1,3)],PVAL[,3]<=0.05),by='GeneNames')
