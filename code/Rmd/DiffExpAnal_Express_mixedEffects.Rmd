...
FactorCovariates = c("Diffname_short", "Gender", "Reprogramming_Vector_Type_Level2", "Cell_Type_of_Origin_Level2", "Donor_Life_Stage", "lane", "run","Donor_ID")
ContCovariates = NULL
```
...
DESIGN = getDesignMatrix(COVARIATES[,c("Diffname_short", "Gender", "Reprogramming_Vector_Type_Level2", "Cell_Type_of_Origin_Level2", "Donor_Life_Stage", "lane", "run")], Intercept = F)
...
```{r gender, cache=TRUE}
# Post adjusted design matrix
DESIGN = getDesignMatrix(COVARIATES[,c("Gender", "Diffname_short",  "Reprogramming_Vector_Type_Level2", "Cell_Type_of_Origin_Level2", "Donor_Life_Stage", "lane", "run","Donor_ID")], Intercept = F)
DESIGN = DESIGN$design[,linColumnFinder(DESIGN$design)$indepCols]
...
# Post adjusted design matrix
DESIGN = getDesignMatrix(COVARIATES[,c("Cell_Type_of_Origin_Level2", "Reprogramming_Vector_Type_Level2", "Diffname_short",  "Gender", "Donor_Life_Stage", "lane", "run","Donor_ID")], Intercept = F)
DESIGN = DESIGN$design[,linColumnFinder(DESIGN$design)$indepCols]
...
# Post adjusted design matrix
DESIGN = getDesignMatrix(COVARIATES[,c("Reprogramming_Vector_Type_Level2", "Diffname_short",  "Gender", "Cell_Type_of_Origin_Level2", "Donor_Life_Stage", "lane", "run","Donor_ID")], Intercept = F)
DESIGN = DESIGN$design[,linColumnFinder(DESIGN$design)$indepCols]
...
|  Differentially expressed genes (genes only)                    |  `r DEXPP$properties$id`        |
