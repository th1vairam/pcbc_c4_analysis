...
```{r predictors, fig.height=10, fig.width=10}
...
DEXP_OBJ = synStore(DEXP_OBJ, used = ALL_USED_IDs, executed = thisFile, activity = 'Predict EB polarisation')
...
MOD_OBJ = synStore(MOD_OBJ, used = ALL_USED_IDs, executed = thisFile, activity = 'Predict EB polarisation')
```