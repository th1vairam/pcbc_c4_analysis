...
knitFile2Synapse(file = "./DiffExpAnal_Express_mixedEffects_atEachDiffState.Rmd", owner = 'syn4122792', wikiName = "Differential Expression Analysis Express Mixed Effects iPScVsHEsc",overwrite=F)
...
if (SYNAPSE_STORE){  
  ...
  thisRepo <- getRepo(repository = "th1vairam/pcbc_c4_analysis", 
                      ref="branch", refName='diff_exp')

  thisFile <- getPermlink(repository = thisRepo,
                          repositoryPath=paste0('code/Rmd/', thisFileName))
  
  CODE <- File(paste0('./', thisFileName), 
               name = 'Differential Expression Analysis Express Mixed Effects iPScVshESc',
               parentId = parentId)

  CODE <- synStore(CODE, activityName = ActivityName, 
