...
if (SYNAPSE_STORE){  
  ...
  CODE <- synStore(CODE, used = ALL_USED_IDs, activityName = ActivityName, executed = 'https://github.com/th1vairam/pcbc_c4_analysis/blob/24f7f51c014ef9f2db7b63910d7f86771b194b79/code/Rmd/DiffExpAnal_Express_mixedEffects_atEachDiffState.Rmd')  
}
```