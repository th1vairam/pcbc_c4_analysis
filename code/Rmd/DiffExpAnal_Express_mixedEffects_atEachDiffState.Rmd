...
if (SYNAPSE_STORE){  
  ...
  CODE <- synStore(CODE, used = ALL_USED_IDs, activityName = ActivityName, executed = 'https://github.com/th1vairam/pcbc_c4_analysis/blob/1b5514b44978f8cd721c408ac2ab5cf6355927fe/code/Rmd/DiffExpAnal_Express_mixedEffects_atEachDiffState.Rmd')  
}
```