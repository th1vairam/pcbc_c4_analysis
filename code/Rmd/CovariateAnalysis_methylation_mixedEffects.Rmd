...
hist(log10(exp.variance), main = "Variance distribution (before removal)", , xlab = 'log10(variance)')
...
hist(log10(exp.variance[!ind.remove1 & !ind.remove2]), main = "Variance distribution (after removal)", xlab = 'log10(variance)')
```
...
# Design Matrix
DESIGN <- rownameToFirstColumn(DESIGN$design,'UID')
