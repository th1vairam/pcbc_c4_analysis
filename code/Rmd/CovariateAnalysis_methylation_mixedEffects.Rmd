...
# knitFile2Synapse(file = "./CovariateAnalysis_methylation_mixedEffects.Rmd", name = 'Covariate Analysis Methylation Mixed Effects', owner = 'syn4231747', overwrite=F)
...
# Code
CODE <- File('./CovariateAnalysis_methylation_mixedEffects.Rmd',name = 'Covariate Analysis Methylation Mixed Effects',parentId = parentId)
...
write.table(EXP,file = './Adjusted_MethylationExpression.tsv',sep='\t',row.names=F,col.names=T,quote=F)
RESID.EXPR <- File('./Adjusted_MethylationExpression.tsv',name = 'Adjusted Expression Methylation Mixed Effects',parentId = parentId)
...
write.table(COVARIATES,file = './Covariates_Methylation_MixedEffects.tsv',sep='\t',row.names=F,col.names=T,quote=F)
COVARIATES <- File('Covariates_Methylation_MixedEffects.tsv',name = 'Covariates Methylation Mixed Effects',parentId = parentId)
...
write.table(DESIGN,file = './AdjustedDesign_Methylation_MixedEffects.tsv',sep='\t',row.names=F,col.names=T,quote=F)
DESIGN <- File('AdjustedDesign_Methylation_MixedEffects.tsv',name = 'Adjusted Design Methylation Mixed Effects',parentId = parentId)
