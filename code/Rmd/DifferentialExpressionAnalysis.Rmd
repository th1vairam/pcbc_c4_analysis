...
# knit2synapse(file = "./DifferentialExpressionAnalysis.Rmd", owner = 'syn3475606', wikiName = "Differential Expression Analysis",overwrite=T)
...
if(SYNAPSE_STORE){
  ...
  CODE <- synStore(CODE, used =ALL_USED_IDs,activityName='Differential Analysis', executed='https://github.com/th1vairam/pcbc_c4_analysis/blob/5e919abd2165a84bbbf101c49d95e524dce684e7/code/Rmd/DifferentialExpressionAnalysis.Rmd')
}
```