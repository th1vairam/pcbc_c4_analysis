...
# Plot fused matrix
Heatmap(fused.eb, col = colorRamp2(c(0,0.5,1), c('white','grey','black')))
```
...
# Plot fused matrix
Heatmap(fused.sc, col = colorRamp2(c(0,0.5,1), c('white','grey','black')))
```
...
# Plot fused matrix
Heatmap(fused.sc.eb, col = colorRamp2(c(0,0.5,1), c('white','grey','black')))
```
