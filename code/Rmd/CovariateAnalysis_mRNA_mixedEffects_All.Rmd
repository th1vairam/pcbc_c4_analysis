...
```
```{r preAdjustedSigCovars.NULL.ALL, fig.width=20, fig.height=12}
...
residualSigCovars = runPCAandPlotCorrelations(RESIDUAL.GENE_EXPRESSION, 
                                              ...
                                              isKeyPlot=TRUE)
```
```{r residualSigCovars, fig.width=20, fig.height=12}
residualSigCovars[["PC_res"]][[1]]$plotData
```
```{r residualSigCovars.ALL, fig.width=20, fig.height=12}
...
residualSigCovars[["PC_res"]][[1]]$plotData
```
```{r residualSigCovars.manual.ALL, fig.width=20, fig.height=12}
residualSigCovars[["PC_res"]][[2]]$plotData
```
