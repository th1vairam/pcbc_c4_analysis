...
# knitFile2Synapse(file = "./CovariateAnalysis_mRNA_mixedEffects_All.Rmd", name = 'Covariate Analysis mRNA Mixed Effects All', owner = 'syn4483760', overwrite=F)
...
```{r preAdjustedSigCovars.NULL, fig.width=15, fig.height=10}
preAdjustedSigCovars[["PC_res"]][[1]]$plotData
```
```{r preAdjustedSigCovars.NULL.ALL, fig.width=15, fig.height=10}
...
residualSigCovars = runPCAandPlotCorrelations(RESIDUAL.GENE_EXPRESSION, 
                                              ...
                                              isKeyPlot=TRUE)
```
```{r residualSigCovars, fig.width=15, fig.height=10}
residualSigCovars[["PC_res"]][[1]]$plotData
```
```{r residualSigCovars.ALL, fig.width=15, fig.height=10}
