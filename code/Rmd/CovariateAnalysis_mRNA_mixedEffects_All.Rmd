...
tmp <- paste('Using following covariates in the final model:', 
             paste(paste(gsub('_','\\\\_',postAdjustCovars$fixed),
                         collapse=', '),
                   'as fixed effects and', 
...
# Post adjusted design matrix
DM1 = getDesignMatrix(dplyr::select(COVARIATES,Diffname_short,Gender,Reprogramming_Gene_Combination, Cell_Type_of_Origin_Level2, Culture_Conditions,run),Intercept = F)
DM1$design = DM1$design[,linColumnFinder(DM1$design)$indepCols]
