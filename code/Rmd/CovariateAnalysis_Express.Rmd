...
# knit2synapse(file = "./CovariateAnalysis_Express.Rmd", owner = 'syn3382512', wikiName = "Covariate Analysis Express",overwrite=T)
...
write.list(SIG.GSETS,file='./DifferentialExpression_DiffnameShort_Significant_Express.txt',t.name=names(SIG.GSETS),quote=F)
...
```{r synapsestore}
if (SYNAPSE_STORE){
  COVARIATES_CODE <- File('./CovariateAnalysis_Express.Rmd',name = 'Covariate Analysis',parentId = parentId)
  COVARIATES_CODE <- synStore(COVARIATES_CODE, used = c(COUNT_OBJ$properties$id,METADATA_OBJ@schema),activityName='Covariate Analysis', executed='https://github.com/th1vairam/pcbc_c4_analysis/blob/cov_anal/code/Rmd/CovariateAnalysis_Express.Rmd')
  ...
  DE <- synStore(DE, used = c(COUNT_OBJ$properties$id,METADATA_OBJ@schema),activityName='Differential Analysis Express', executed=COVARIATES_CODE)
  DE_Sig <- File('./DifferentialExpression_DiffnameShort_Significant_Express.txt',name = 'Differential Expression DiffnameShort Significant Express',parentId = parentId)
  DE_Sig <- synStore(DE_Sig, used = c(COUNT_OBJ$properties$id,METADATA_OBJ@schema,DE$properties$id),activityName='Differential Analysis Express', executed=COVARIATES_CODE)
}
```
