...
```{r decompse.normalise.data, cache=TRUE}
...
if (SYNAPSE_STORE){  
  ...
  write.table(VOOM.ADJUSTED.GENE_EXPRESSION$weights,file = './AdjustedWeights_Express.tsv',sep='\t',row.names=F,col.names=T,quote=F)
  ...
  write.table(VOOM.ADJUSTED.GENE_EXPRESSION$design,file = './AdjustedDesign_Express.tsv',sep='\t',row.names=F,col.names=T,quote=F)
