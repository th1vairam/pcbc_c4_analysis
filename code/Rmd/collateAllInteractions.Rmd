...
splicing.mrna <- downloadFile('syn5048714') %>%  
  ...
  unique %>%
  dplyr::mutate(feature.assay = 'spliceJunction', target.assay = 'mrna', 
                dataSource = 'AltAnalyze')
```

#### Combine all interactions
```{r combine}
allInteractions = rbindlist(list(TFsMapping, miRNA.mRNA3, methyl.mirna, methyl.mrna, splicing.mrna)) %>%
  unique %>%
