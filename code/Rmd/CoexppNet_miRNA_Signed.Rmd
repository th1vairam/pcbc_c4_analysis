...
# Store Module Files
MOD = data.frame(ID = colnames(EXPR) , merged = mergedNetModules.colors, unmerged = unmergedNetModules.colors)
...
MEs = cbind(data.frame(ID =  rownames(EXPR)), mergedMEs[[1]]$data)
...
|  *Results*           |  *SynapseID*                                                               |
|  -------             |   ---------                                                                |
|  Modules             |  `r paste(MOD$properties$id,MOD$properties$versionNumber,sep='.')`         |
|  Module Eigen miRNAs |  `r paste(MEs$properties$id,MEs$properties$versionNumber,sep='.')`         |
