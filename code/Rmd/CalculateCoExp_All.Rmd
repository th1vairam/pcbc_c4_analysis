...
TF.TF.correlation = join_all(TF.TF.correlation, by = c("feature","feature1","feature2")) %>%
  dplyr::mutate(Assay1 = 'TF', Assay2 = 'TF', nSamples = dim(metadata.TF.TF)[1]) %>%
  dplyr::select(feature, feature1, Assay1, feature2, Assay2, nSamples, 
                DE, EB, ECTO, MESO15, MESO30, MESO5, SC)
...
TF.nonTF.correlation = join_all(TF.nonTF.correlation, by = c("feature","feature1","feature2")) %>%
  dplyr::mutate(Assay1 = 'TF', Assay2 = 'nonTF', nSamples = dim(metadata.TF.nonTF)[1]) %>%
  dplyr::select(feature, feature1, Assay1, feature2, Assay2, nSamples, 
                DE, EB, ECTO, MESO15, MESO30, MESO5, SC)
...
mirna.mrna.correlation = join_all(mirna.mrna.correlation, by = c("feature","feature1","feature2")) %>%
  dplyr::mutate(Assay1 = 'mirna', Assay2 = 'mrna', nSamples = dim(metadata.mirna.mrna)[1]) %>%
  dplyr::select(feature, feature1, Assay1, feature2, Assay2, nSamples, 
                DE, EB, ECTO, MESO15, MESO30, MESO5, SC)
...
methyl.mrna.correlation = join_all(methyl.mrna.correlation, by = c("feature","feature1","feature2")) %>%
  dplyr::mutate(Assay1 = 'mirna', Assay2 = 'mrna', nSamples = dim(metadata.methyl.mrna)[1]) %>%
  dplyr::select(feature, feature1, Assay1, feature2, Assay2, nSamples, 
                DE, EB, ECTO, MESO5, SC)
...
methyl.mirna.correlation = join_all(methyl.mirna.correlation, by = c("feature","feature1","feature2")) %>%
  dplyr::mutate(Assay1 = 'mirna', Assay2 = 'mrna', nSamples = dim(metadata.methyl.mirna)[1]) %>%
  dplyr::select(feature, feature1, Assay1, feature2, Assay2, nSamples, 
                DE, EB, ECTO, MESO5, SC)
