...
TF.nonTF.correlation = lapply(metadata.TF.nonTF, calculateCor, TF_mat_median, nonTF_mat_median, features[1:1000,], 'TF', 'nonTF')
...
# Store metadata
metadata <- list(TF_nonTF = metadata.TF.nonTF,
                 mrna_mirna = metadata.mrna.mirna, 
...
# Store coexpression
CoExp <- list(TF_nonTF = TF.nonTF.correlation,
              mrna_mirna = mrna.mirna.correlation, 
