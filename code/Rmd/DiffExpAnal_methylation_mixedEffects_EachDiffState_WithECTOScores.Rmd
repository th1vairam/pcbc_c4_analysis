---
title: "Differential expression analysis for methylation data with mixed effects modeling at SC state with EB polarisation scores"
...
postAdjustedCovars = c('eb.pol.scores', 'Reprogramming_Vector_Type', 'Gender')
