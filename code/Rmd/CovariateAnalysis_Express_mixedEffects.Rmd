...
if (SYNAPSE_STORE){  
  ...
  EXPR <- rownameToFirstColumn(RESID.EXPR,'GeneName')  
  write.table(EXPR,file = './Adjusted_Expression.tsv',sep='\t',row.names=F,col.names=T,quote=F)
  ...
  # Adjustment Weights 
  WEIGHTS <- cbind(EXPR$GeneName,VOOM.ADJUSTED.GENE_EXPRESSION$weights)
