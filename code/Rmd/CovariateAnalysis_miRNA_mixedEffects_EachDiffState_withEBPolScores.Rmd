...
knit2synapse::knitToFolderEntity(file = './CovariateAnalysis_miRNA_mixedEffects_EachDiffState_withEBPolScores.Rmd',
                                 parentId = 'syn5008934',
                                 entityName = 'Covariate Analysis miRNA Mixed Effects EachDiffState WithEBPolScores')
```
