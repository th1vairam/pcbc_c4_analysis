---
title: Summary of all differential and coexpression analysis 
...
p = ggplot(tmp, aes(x = PC1, y = PC2, shape = Diffname_short, color = Diffname_short)) + geom_point()
...
```
Above PC plot shows 5 different clusters in the RNA assays and 4 in the DNA methylation expression. Based on the three different assays, we can see DE cluster together with MESODERM at day 5 and MESODERMS at day 15 and 30 cluster together and are more close to EB's.