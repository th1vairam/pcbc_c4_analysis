---
title: "Covariate Analysis for eXpress aligned data with mixed effect modeling with out any gene filtering"
...
# knitFile2Synapse(file = "./CovariateAnalysis_Express_mixedEffects_WOFiltering.Rmd", name = 'Covariate Analysis Express Mixed Effects WOFiltering', parentId =  'syn3276099', overwrite=F)
...
if (SYNAPSE_STORE){  
  ActivityName <- 'Covariate Analysis of eXpress aligned data with mixed effects modeling without filtering genes'
  
  thisFileName <- 'CovariateAnalysis_Express_mixedEffects_WOFiltering.Rmd'
  ...
  # Code
  CODE <- File('./CovariateAnalysis_Express_mixedEffects_WOFiltering.Rmd',name = 'Covariate Analysis Express Mixed Effects WOFiltering',parentId = parentId)
  ...
  write.table(EXP,file = './AdjustedExpression_Express_MixedEffects_WOFiltering.tsv',sep='\t',row.names=F,col.names=T,quote=F)
  EXPRESSION <- File('./AdjustedExpression_Express_MixedEffects_WOFiltering.tsv',name = 'Adjusted Expression Express Mixed Effects WOFiltering',parentId = parentId)
  ...
  write.table(WEIGHTS,file = './AdjustedWeights_Express_MixedEffects_WOFiltering.tsv',sep='\t',row.names=F,col.names=T,quote=F)
  WEIGHTS <- File('AdjustedWeights_Express_MixedEffects_WOFiltering.tsv',name = 'Adjusted Weights Express Mixed Effects WOFiltering',parentId = parentId)
  ...
  write.table(COVARIATES,file = './Covariates_Express_MixedEffects_WOFiltering.tsv',sep='\t',row.names=F,col.names=T,quote=F)
  COVARIATES <- File('Covariates_Express_MixedEffects_WOFiltering.tsv',name = 'Covariates Express Mixed Effects WOFiltering',parentId = parentId)
  ...
  write.table(DESIGN,file = './AdjustedDesign_Express_MixedEffects_WOFiltering.tsv',sep='\t',row.names=F,col.names=T,quote=F)
  DESIGN <- File('AdjustedDesign_Express_MixedEffects_WOFiltering.tsv',name = 'Adjusted Design Express Mixed Effects WOFiltering',parentId = parentId)
