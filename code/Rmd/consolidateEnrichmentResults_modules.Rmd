...
write.xlsx(OR, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'mRNA-OR-FDR0.01-Top100', row.names=F, append = F)
...
write.xlsx(gx, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'mRNA-Genes-FDR0.01-Top100', row.names=F, append = T)
```
...
OR = dplyr::select(mirna.result, CategoryName, GeneSetName, cluster,
                   one_of("Early.OR", "SC.OR", "SC and DE.OR", "DE and MESO5.OR", 
                          "MESO5.OR", "ECTO.OR", "SC and ECTO.OR", "MESO15.OR", 
                          "EB.OR")) %>% as.data.frame
write.xlsx(OR, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'miRNA-OR-FDR0.01-Top100', row.names=F, append = T)
gx = dplyr::select(mirna.result, CategoryName, GeneSetName, cluster,
  ...
  as.data.frame
write.xlsx(gx, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'miRNA-Genes-FDR0.01-Top100', row.names=F, append = T)
...
write.xlsx(mirna, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'miRNA-miRNA-FDR0.01-Top100', row.names=F, append = T)
```
...
write.xlsx(OR, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'methyl-OR-FDR0.01-Top100', row.names=F, append = T)
...
write.xlsx(gx, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'methyl-Genes-FDR0.01-Top100', row.names=F, append = T)
...
write.xlsx(methyl, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'methyl-methyl-FDR0.01-Top100', row.names=F, append = T)
```
...
write.xlsx(OR, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'splicing-OR-FDR0.01-Top100', row.names=F, append = T)
gx = dplyr::select(splicing.result, CategoryName, GeneSetName, cluster,
                   one_of('Early.Genes','ECTO.Genes','Late1.Genes','Late3.Genes')) %>%
  as.data.frame
write.xlsx(gx, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'splicing-Genes-FDR0.01-Top100', row.names=F, append = T)
...
splicing = gx %>%
  dplyr::mutate_each(funs(map.mrna), -CategoryName, -GeneSetName, -cluster)
write.xlsx(splicing, file = 'enrichmentAnalysis_clusters_top100.xlsx', sheetName = 'splicing-Junctions-FDR0.01-Top100', row.names=F, append = T)
```
