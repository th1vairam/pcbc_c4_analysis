...
Since, EBs are derivatives of pluripotent states, we characterised our EBs as a mixture model of the above identified signatures
#### mRNA
```{r pca.ebs.mrna}
# Get mrna expression
tmp = expr$mrna %>%
...
covars1[,cont_covars,drop=F] = lapply(covars[,cont_covars,drop=F], as.numeric)
