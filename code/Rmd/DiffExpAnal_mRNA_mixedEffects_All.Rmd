...
GENDER <- doDiffExpr(PROC_COUNT = PROC_COUNT, DESIGN = DESIGN,
                     WEIGHTS = WEIGHTS, block=COVARIATES$Donor_ID,
                     comparison=comparison)
...
REP.GENE.COMBO <- doDiffExpr(PROC_COUNT = PROC_COUNT, DESIGN = DESIGN,
                             WEIGHTS = WEIGHTS, block=COVARIATES$Donor_ID,
                             comparison=comparison)
...
CELL.TYPE.OF.ORIGIN <- doDiffExpr(PROC_COUNT = PROC_COUNT, DESIGN = DESIGN,
                                  WEIGHTS = WEIGHTS, block=COVARIATES$Donor_ID,
                                  comparison=comparison)
...
CULT.COND <- doDiffExpr(PROC_COUNT = PROC_COUNT, DESIGN = DESIGN,
                        WEIGHTS = WEIGHTS, block=COVARIATES$Donor_ID,
                        comparison=comparison)
