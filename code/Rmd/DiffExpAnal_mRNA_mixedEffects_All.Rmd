...
write.table(DEXPP.GENES,file='./DiffExpAnal_mRNA_mixedEffects_All_diffGenes.gct',
            sep='\t',row.names=F,quote=F)
DEXPP_OBJ <- File('./DiffExpAnal_mRNA_mixedEffects_All_diffGenes.gct',
                  name = 'Differentially Expressed Genes gct format',
                  parentId = CODE$properties$id)

synSetAnnotations(DEXPP_OBJ) <- list(dataType="mRNA", fileType="gct", q=0.05, fc=0)

DEXPP_OBJ <- synStore(DEXPP_OBJ, used = ALL_USED_IDs, 
                      activityName = activityName, executed=thisFile)
