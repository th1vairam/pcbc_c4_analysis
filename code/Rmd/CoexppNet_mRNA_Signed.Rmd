...
```{r sample.pc, fig.height=15, fig.width=15}
...
```{r sample.clustering, fig.height=15, fig.width=25}
...
unmergedNetModules = blockwiseModules(EXPR,
                       maxBlocksize = 10000,
                       corType = "bicor",
                       power = softPower,
                       networkType = "signed",
...
# Merge modules
mergedNetModules = mergeCloseModules(fixDataStructure(EXPR), unmergedNetModules.colors, cutHeight = 0.2, verbose = 3)
