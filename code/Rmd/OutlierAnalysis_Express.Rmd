...
8. Check Diffname_short for SC12-034MESO.219.1, it says EB
...
if (SYNAPSE_STORE){
  ...
  OUTLIER_CODE <- synStore(OUTLIER_CODE, used = c(COUNT_OBJ$properties$id,METADATA_OBJ@schema),activityName='Outlier Analysis', executed='https://github.com/th1vairam/pcbc_c4_analysis/blob/cov_anal/code/Rmd/OutlierAnalysis_Express.Rmd')
