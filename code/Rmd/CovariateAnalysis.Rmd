...
while (length(residualSigCovars$significantCovars) != 0){
  print(paste('Using following covariates in the model',postAdjustCovars,sep=':'))
...
# Find PC of residual gene expression and significant covariates that are highly correlated with PCs
residualSigCovars = runPCAandPlotCorrelations(RESIDUAL.GENE_EXPRESSION, DM$design,'all adjusted design(voom-normalized)',isKeyPlot=TRUE)
```
