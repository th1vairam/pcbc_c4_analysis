...
```{r synapsestore1, echo=FALSE, include=FALSE, eval=TRUE, cache = FALSE}
...
TF.TF.fisher = apply(all.comparisons, 1, changeCoExp,
                     ...
                     var1 = 'TF.regulator', var2 = 'TF.regulated', FDR = 1.1, logFC = 0)
...
D = mapply(function(x,y){
  ...
  x = x %>%
    ...
    plyr::rename(c(correlation.group1 = group[1], correlation.group2 = group[2])) %>%
...
tmp = ldply(uniqueFeatures, function(x){
  tmp = data.frame(value = paste(x, collapse = ';'))
  tmp$value = gsub('_','\\\\_', tmp$value)
}, .id = 'Comparison')
writeLines("They are")
kable(tmp)
...
write.table(TF.TF.fisher, file='changeCoExp_TF_TF.tsv', sep = '\t', quote=F, row.names=F)
obj = File('changeCoExp_TF_TF.tsv', name = 'Fishers Change in Coexpression TF_TF', parentId = CODE$properties$id)
obj = synStore(obj, used = as.character(ALL_USED_IDs), executed = ThisFile, activityName = ActivityName)

rm(list = c('TF.TF.fisher','tmp', 'all.comparisons'))
WGCNA::collectGarbage()
```
...
TF.nonTF.fisher = apply(all.comparisons, 1, changeCoExp, 
                        ...
                        var1 = 'TF', var2 = 'nonTF', FDR = 1.1, logFC = 0)
...
write.table(TF.nonTF.fisher, file='changeCoExp_TF_nonTF.tsv', sep = '\t', quote=F, row.names=F)
obj = File('changeCoExp_TF_nonTF.tsv', name = 'Fishers Change in Coexpression TF_nonTF', parentId = CODE$properties$id)
obj = synStore(obj, used = as.character(ALL_USED_IDs), executed = ThisFile, activityName = ActivityName)

rm(list = c('TF.nonTF.fisher', 'tmp', 'all.comparisons'))
WGCNA::collectGarbage()
```
...
mirna.TF.fisher = apply(all.comparisons, 1, changeCoExp, 
                        ...
                        var1 = 'mrna', var2 = 'mirna', FDR = 1.1, logFC = 0)
...
write.table(mirna.TF.fisher, file='changeCoExp_mirna_TF.tsv', sep = '\t', quote=F, row.names=F)
obj = File('changeCoExp_mirna_TF.tsv', name = 'Fishers Change in Coexpression mirna_TF', parentId = CODE$properties$id)
obj = synStore(obj, used = as.character(ALL_USED_IDs), executed = ThisFile, activityName = ActivityName)

rm(list = c('mirna.TF.fisher', 'tmp', 'all.comparisons'))
WGCNA::collectGarbage()
```
...
methyl.TF.fisher = apply(all.comparisons, 1, changeCoExp, 
                         ...
                         var1 = 'mrna', var2 = 'methyl', FDR = 1.1, logFC = 0)
...
write.table(methyl.TF.fisher, file='changeCoExp_methyl_TF.tsv', sep = '\t', quote=F, row.names=F)
obj = File('changeCoExp_methyl_TF.tsv', name = 'Fishers Change in Coexpression methyl_TF', parentId = CODE$properties$id)
obj = synStore(obj, used = as.character(ALL_USED_IDs), executed = ThisFile, activityName = ActivityName)

rm(list = c('methyl.TF.fisher', 'tmp', 'all.comparisons'))
WGCNA::collectGarbage()
```
...
write.table(mirna.nonTF.fisher, file='changeCoExp_mirna_nonTF.tsv', sep = '\t', quote=F, row.names=F)
obj = File('changeCoExp_mirna_nonTF.tsv', name = 'Fishers Change in Coexpression mirna_nonTF', parentId = CODE$properties$id)
obj = synStore(obj, used = as.character(ALL_USED_IDs), executed = ThisFile, activityName = ActivityName)

rm(list = c('mirna.nonTF.fisher', 'tmp', 'all.comparisons'))
WGCNA::collectGarbage()
```
...
methyl.mirna.fisher = apply(all.comparisons, 1, changeCoExp, 
                            ...
                            var1 = 'mirna', var2 = 'methyl', FDR = 1.1, logFC = 0)
...
write.table(methyl.mirna.fisher, file='changeCoExp_methyl_mirna.tsv', sep = '\t', quote=F, row.names=F)
obj = File('changeCoExp_methyl_mirna.tsv', name = 'Fishers Change in Coexpression methyl_mirna', parentId = CODE$properties$id)
obj = synStore(obj, used = as.character(ALL_USED_IDs), executed = ThisFile, activityName = ActivityName)
```

### Store results in synapse
```{r synapsestore2, echo=FALSE, include=FALSE, eval=TRUE, cache = FALSE}
# Clusters
